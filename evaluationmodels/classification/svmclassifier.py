...
class SVMClassifierModel(evaluationmodels.BaseClassifierModel):
    ...
    def set_algorithm(self, algorithm_name, algorithm_hyperparameters):
        ...
        self.config.algorithm.parameters = gr.config.update_config(algorithm_hyperparameters,
                                                                   self.config.algorithm.hyperparameters)
    ...
    def run_representation_testing(self, dataloader, testing_config=None, train_loader=None, valid_loader=None,
                                   logger=None):
        test_data = dict()
