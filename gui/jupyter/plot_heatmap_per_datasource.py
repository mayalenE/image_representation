...
def plot_heatmap_per_datasource(data=None, experiment_ids=None, data_source=None, repetition_ids=None, config=None, **kwargs):
    default_config = dict(
    ...
    for datasource_idx, cur_data_source in enumerate(data_source):
        ...
        trace_label = goalrepresent.gui.jupyter.misc.replace_str_from_dict(str(trace_label), {'datasource_idx': datasource_idx,
    ...
    return goalrepresent.gui.jupyter.plotly_heatmap(data=plot_data, config=config)