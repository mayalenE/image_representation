...
def plotly_meanstd_scatter(data=None, config=None, **kwargs):
    ...
    for subplot_idx, subplot_data in enumerate(data):
        ...
        for data_idx, cur_data in enumerate(subplot_data):
            ...
            mean_label = gr.gui.jupyter.misc.replace_str_from_dict(str(mean_label), {'data_idx': data_idx})
            ...
            mean_trace_params = gr.config.set_default_config(mean_trace_config, mean_trace_params)
            ...
            for cur_elem_idx in range(n_elems):
                ...
                element_label = gr.gui.jupyter.misc.replace_str_from_dict(str(element_label), {'data_idx': data_idx,
                ...
                color = gr.gui.jupyter.misc.transform_color_tuple_to_str(color)
